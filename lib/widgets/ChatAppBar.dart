...
import 'package:solidsniffle/config/Assets.dart';
import 'package:solidsniffle/config/Palette.dart';
                                      ...
                                      Expanded(
                                          ...
                                          child: Container(
                                              child: Column(
                                                ...
                                                mainAxisSize: MainAxisSize.min,
                                                children: <Widget>[
                                                  Text('Siddharth Mohanty', style: textHeading),
                                                  Text('@theboy_who_lives', style: textStyle)
                                                ],
                                              ))),
                                    ],
                                  )),
